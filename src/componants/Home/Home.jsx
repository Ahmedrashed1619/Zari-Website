              ...
              <div className="row d-flex justify-content-center align-items-center">
                <div className="col-8">
                  <div className="caption-details wow fadeInLeft" data-wow-duration="1.5s">
                    <h2 className="fw-bold mb-3 text-white wow fadeInDownBig" data-wow-duration="1s" data-wow-delay="0.5s">{isEng ? fetchHome.projects.date[3].title : fetchHome.projects.date[3].titleAr}</h2>
                ...
                <div className="col-4">
                  <div className="img-details text-center wow fadeInRight" data-wow-duration="1.5s">
                    <img src={fetchHome.projects.date[3].image ? fetchHome.projects.date[3].image : zariExpress} className="mx-auto" alt="zari Express" />
                  </div>
                </div>
              </div>
            </div>
